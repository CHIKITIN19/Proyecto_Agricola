...
import Model.Trabajadores.TrabajadoresMapper;
import Model.Usuarios.UsuariosDAO;
import Model.Usuarios.UsuariosMapper;
...
public class UsuariosController {
    ...
    private UsuariosDTO usuarioLogueado; // Usuario actualmente logueado

    public UsuariosController(View view) {
        this.view = view;
        try {
            ...
            this.dao = new UsuariosDAO(connection);
    ...
    public boolean registrarUsuario(String userName, String password, int rol) {
        ...
        try {
            ...
            UsuariosDTO nuevoUsuario = new UsuariosDTO(0, userName, hashedPassword, rol);
    ...
    public boolean actualizarPassword(String userName, String newPassword) {
        try {
            UsuariosDTO usuario = dao.read(userName);
            if (usuario == null) {
    ...
    public UsuariosDTO getUsuarioLogueado() {
